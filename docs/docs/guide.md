...
first are in [`20-contract.md`](../../design/20-contract.md).
...
[`20-contract.md`](../../design/20-contract.md).
...
Full error-variant tables, with every retry rule, live in [`20-contract.md`](../../design/20-contract.md).
...
[`10-design.md`](../../design/10-design.md) and [`20-contract.md`](../../design/20-contract.md).
...
- [`20-contract.md`](../../design/20-contract.md) — exact TypeScript/C# signatures, the full
  schema, every error variant, and the numbered invariants.
- [`10-design.md`](../../design/10-design.md) — the fuller account of the mechanisms summarised
