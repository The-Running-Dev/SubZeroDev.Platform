...
(`SubZeroDev.ServiceContract` PR #10, regenerated against engine `b7e21e7`), so this repository's
own engine pin moves to the same `0.10.0` in the same commit — otherwise every startup fails
