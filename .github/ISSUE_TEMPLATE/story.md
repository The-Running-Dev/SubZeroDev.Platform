...
- **Authority:** this issue, and only until it needs more. If it turns out to need a contract, a schema, or a public interface, **it is not a story** — stop and run `/brief`, and let it become a brief.
